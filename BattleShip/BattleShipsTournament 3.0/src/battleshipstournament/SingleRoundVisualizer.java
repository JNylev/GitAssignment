...
public class SingleRoundVisualizer
{
    public static void main(String[] args)
    {
        ...
        PlayerFactory<BattleshipsPlayer> playerAFactory = Loader.loadPlayer("C:\\ai\\E1.jar", "e1.E1");
        PlayerFactory<BattleshipsPlayer> playerBFactory = Loader.loadPlayer("C:\\ai\\E2.jar", "e2.E2");
